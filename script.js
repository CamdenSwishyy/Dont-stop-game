...
function getChoiceChance(choiceName) { return Math.min(1, choices[choiceName].chance + state.luckLevel * .03); }
...
function render() {
  ...
  $('luck-upgrade-level').textContent = `Level ${state.luckLevel} · +${state.luckLevel * 3}% odds`;
